...
# 
COMMON_GLOBAL_CFLAGS += -DICS_AUDIO_BLOB -DHAVE_PRE_KITKAT_AUDIO_BLOB -DAUDIO_LEGACY_HACK
COMMON_GLOBAL_CFLAGS += -DOMAP_ICS_CAMERA -DCAMERA_LEGACY_HACK -DICS_CAMERA_BLOB
COMMON_GLOBAL_CFLAGS += -DNEEDS_VECTORIMPL_SYMBOLS -DHAS_CONTEXT_PRIORITY -DFIX_ROTATION_GLITCH
